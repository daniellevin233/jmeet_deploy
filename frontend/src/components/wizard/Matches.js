...
const Matches = ({ data }) => {
  ...
  const fourPeople = Object.keys(data);
  const person1 = fourPeople[0];
  const person2 = fourPeople[1];
  const person3 = fourPeople[2];
  const person4 = fourPeople[3];
    ...
    <div className="content">
      <Row>
        <Col>
          ...
          <CardDeck>
            <Person
              fisrtName={data[person1].firstName}
        ...
        <Col>
          ...
          <CardDeck>
            <Person
              fisrtName={data[person2].firstName}
      ...
      <Row>
        <Col>
          ...
          <CardDeck>
            <Person
              fisrtName={data[person3].firstName}
              age={data[person3].age}
              image={src}
            />
          </CardDeck>
          {/* </Button> */}
        ...
        <Col>
          ...
          <CardDeck>
            <Person
              fisrtName={data[person4].firstName}
              age={data[person4].age}
              image={src}
            />
          </CardDeck>
          {/* </Button> */}
